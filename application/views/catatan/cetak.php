      ...
      <div class="mx-auto" style="width: 750px;">
         ...
         <table class="table table-sm">
            ...
            <tbody>
               <tr>
                  <td><b>KAS</b></td>
                  <td align="right"><?= number_format($catatan[0][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[0][$akhirtahun]) ?></td>
               </tr>
               <tr>
                  <td>- Kas PK</td>
               ...
               <tr>
                  ...
                  <td align="right"><?= number_format($catatan[5][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[5][$akhirtahun]) ?></td>
               </tr>
               <tr>
                  <td>- Kas Dan Bank Yang Dibatasi Penggunaanya</td>
               ...
               <tr>
                  ...
                  <td align="right"><?= number_format($catatan[7][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[7][$akhirtahun]) ?></td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <td align="right"><?= number_format($catatan[16][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[16][$akhirtahun]) ?></td>
               </tr>
               <tr>
                  <td>- Sektor Industri</td>
               ...
               <tr>
                  ...
                  <td align="right"><?= number_format($catatan[25][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[25][$akhirtahun]) ?></td>
               </tr>
               <tr>
                  <td>- Piutang Jasa Administrasi Pinjaman</td>
               ...
               <tr>
                  ...
                  <td align="right"><?= number_format($catatan[27][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[27][$akhirtahun]) ?></td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <td align="right"><?= number_format($catatan[29][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[29][$akhirtahun]) ?></td>
               </tr>
               <tr>
                  <td>- Inventaris Kantor</td>
               ...
               <tr>
                  ...
                  <td align="right"><?= number_format($catatan[31][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[31][$akhirtahun]) ?></td>
               </tr>
               <tr>
                  <td>- Sektor Industri</td>
               ...
               <tr>
                  ...
                  <td align="right"><?= number_format($catatan[40][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[40][$akhirtahun]) ?></td>
               </tr>
               <tr>
                  <td>- Sektor Industri</td>
               ...
               <tr>
                  ...
                  <td align="right"><?= number_format($catatan[49][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[49][$akhirtahun]) ?></td>
               </tr>
               <tr>
                  <td>- Kelebihan Pembayaran Angsuran</td>
                  <td align="right"><?= number_format($catatan[50][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[50][$akhirtahun]) ?></td>
               </tr>
               <tr>
                  <td>- Angsuran Belum Teridentifikasi</td>
               ...
               <tr>
                  ...
                  <td align="right"><?= number_format($catatan[52][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[52][$akhirtahun]) ?></td>
               </tr>
               <tr>
                  <td>- Aktiva Bersih Awal Perioda</td>
               ...
               <tr>
                  ...
                  <td align="right"><?= number_format($catatan[54][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[54][$akhirtahun]) ?></td>
               </tr>
               <tr>
                  <td>- Jasa Administrasi Pinjaman</td>
               ...
               <tr>
                  ...
                  <td align="right"><?= number_format($catatan[60][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[60][$akhirtahun]) ?></td>
               </tr>
               <tr>
                  <td>- Beban Adm dan Umum</td>
                  <td align="right"><?= number_format($catatan[61][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[61][$akhirtahun]) ?></td>
               </tr>
               <tr>
                  <td>- Beban Adm dan Umum BL</td>
               ...
               <tr>
                  ...
                  <td align="right"><?= number_format($catatan[63][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[63][$akhirtahun]) ?></td>
               </tr>
               <tr>
                  <td>- Sektor Industri</td>
               ...
               <tr>
                  ...
                  <td align="right"><?= number_format($catatan[72][$perioda]) ?></td>
                  <td align="right"><?= number_format($catatan[72][$akhirtahun]) ?></td>
               </tr>
               <tr>
                  <td>- Lain-lain</td>
